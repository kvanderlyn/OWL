                        ...
                        <Field>
                              ...
                              {availableData?.data?.available && (
                                    <FieldDescription className="text-green-700">
                                          {watch("username")} is available
                                    </FieldDescription>
                              )}
                              {availableSuccess && !availableData?.data?.available && (
                              ...
                              <InputGroup>
                                    ...
                                    <InputGroupAddon align="inline-end">
                                          <InputGroupButton
                                                ...
                                                size="icon-xs"
                                                aria-label={`${showPw.password ? "Show" : "Hide"} password`}
                                                title={`${showPw.password ? "Show" : "Hide"} password`}
                                          >
                              ...
                              <InputGroup>
                                    ...
                                    <InputGroupAddon align="inline-end">
                                          <InputGroupButton
                                                ...
                                                size="icon-xs"
                                                aria-label={`${showPw.confirm ? "Show" : "Hide"} password`}
                                                title={`${showPw.confirm ? "Show" : "Hide"} password`}
                                          >
